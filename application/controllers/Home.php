...
class Home extends CI_Controller {
	...
	{	
        ...
        $this->data['works'] = $this->db->get_where('work',array('cat !=' => 'POPUP','status =' => '0','featured ='=>'0'))->result_array();
        $this->data['popup'] = $this->db->order_by("id", "DESC")->get_where('work',array('status =' => '0','featured ='=>'0','cat'=>'POPUP'),'1')->result_array();
