					...
					<div class="row">
						<div class="col-md-6">
							...
							<ul class="contact-details">
                                ...
                                <li><a href="#"><i class="icon-mail-2"></i> <span class="__cf_email__" data-cfemail="d1b8bfb7be91a8bea4a3b2bebca1b0bfa8ffb2bebc">[email&#160;protected]</span></a></li>
                            </ul>
                            <!-- End Contact Info -->
						</div>
						<div class="col-md-6">
			...
			<div class="navbar navbar-default navbar-top">
				<div class="container">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="index.html"><img alt="" src="images\vella.png"></a>
					</div>
                ...
                <div class="fullwidthbanner">
                    <ul>
                        ...
                        <li data-transition="fade" data-slotamount="7" data-masterspeed="300">
                            <!-- MAIN IMAGE -->
                            <img src="images\slide-02-bg.jpeg" data-fullwidthcentering="on" alt="slidebg2" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat">
                            ...
                            <!-- LAYER NR. 5 -->
                            <div class="tp-caption sfl start" data-x="180" data-y="bottom" data-speed="1000" data-start="1000" data-easing="Power1.easeOut"><img src="images\slide-02-image-01.png" alt="">
                            </div>
                        ...
                        <li data-transition="fade" data-slotamount="7" data-masterspeed="300">
                            <!-- MAIN IMAGE -->
                            <img src="images\slide-03-bg.jpeg" data-fullwidthcentering="on" alt="slidebg3" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat">
                            ...
                            <!-- LAYER NR. 7 -->
                            <div class="tp-caption sfr start" data-x="center" data-y="60" data-hoffset="100" data-speed="600" data-start="1000" data-easing="easeOutBack" style="z-index: 2"><img src="images\slide-03-image-01.png" alt="">
                            </div>
                        ...
                        <li data-transition="fade" data-slotamount="7" data-masterspeed="300">
                            <!-- MAIN IMAGE -->
                            <img src="images\slide-01-bg.jpeg" data-fullwidthcentering="on" alt="slidebg1" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat">
		...
		<div id="content" class="full-sections">
        	...
        	<div class="section" style="padding-top:60px; padding-bottom:0px; border-top:1px solid #eee; border-bottom:1px solid #eee; background: url(images/browser-section.jpeg) #f9f9f9;">
            	<div class="container">
                    ...
                    <!-- Vella Browser Image -->
                	<div class="text-center"><img data-animation="fadeInUp" data-animation-delay="02" alt="" src="images\browser.png"></div>
                ...
                <div class="container">
                    ...
                    <video class="section-video" poster="images/video/poster.jpg" autoplay="" loop="" preload="none">
                        ...
                        <object type="application/x-shockwave-flash" data="images\video\flashmediaelement.swf"> 		
                            ...
                            <img src="images\video\poster.jpeg" alt="No Video Image" title="No video playback capabilities">
                        </object> 	
                    </video>
                        ...
                        <div class="projects-carousel touch-carousel navigation-3">
                                ...
                                <div class="portfolio-border">
                                    ...
                                    <div class="portfolio-thumb">
                                        <a class="lightbox" data-lightbox-type="ajax" href="https://vimeo.com/78468485">
                                            ...
                                            <img alt="" src="images\portfolio-01.jpeg">
                                        </a>
                                    </div>
                                    <!-- End Project Thumb -->
                            ...
                            <div class="portfolio-item item">
                                <div class="portfolio-border">
                                    <!-- Start Project Thumb -->
                                    <div class="portfolio-thumb">
                                        <a class="lightbox" title="This is an image title" href="images\portfolio-big-01.jpeg">
                                            <div class="thumb-overlay"><i class="icon-resize-full"></i></div>
                                            <img alt="" src="images\portfolio-02.jpeg">
                                        </a>
                                    </div>
                                    <!-- End Project Thumb -->
                                    <!-- Start Project Details -->
                                ...
                                <div class="portfolio-border">
                                    ...
                                    <div class="portfolio-thumb">
                                        <a href="#">
                                            ...
                                            <img alt="" src="images\portfolio-06.jpeg">
                                        </a>
                                    </div>
                                    <!-- End Project Thumb -->
                                    <!-- Start Project Details -->
                            ...
                            <div class="portfolio-item item">
                                <div class="portfolio-border">
                                    <!-- Start Project Thumb -->
                                    <div class="portfolio-thumb">
                                        <a class="lightbox" title="This is an image title" href="images\portfolio-big-03.jpeg">
                                            <div class="thumb-overlay"><i class="icon-resize-full"></i></div>
                                            <img alt="" src="images\portfolio-07.jpeg">
                                        </a>
                                    </div>
                                    <!-- End Project Thumb -->
                                    <!-- Start Project Details -->
                            ...
                            <div class="portfolio-item item">
                                <div class="portfolio-border">
                                    ...
                                    <div class="portfolio-thumb">
                                        <a href="#">
                                            <div class="thumb-overlay"><i class="icon-link-1"></i></div>
                                            <img alt="" src="images\portfolio-08.jpeg">
                                        </a>
                                    </div>
                                    <!-- End Project Thumb -->
                                    <!-- Start Project Details -->
                            ...
                            <div class="portfolio-item item">
                                <div class="portfolio-border">
                                    ...
                                    <div class="portfolio-thumb">
                                        <a href="#">
                                            <div class="thumb-overlay"><i class="icon-link-1"></i></div>
                                            <img alt="" src="images\portfolio-03.jpeg">
                                        </a>
                                    </div>
                                    <!-- End Project Thumb -->
                                    <!-- Start Project Details -->
                            ...
                            <div class="portfolio-item item">
                                <div class="portfolio-border">
                                    ...
                                    <div class="portfolio-thumb">
                                        <a href="#">
                                            <div class="thumb-overlay"><i class="icon-link-1"></i></div>
                                            <img alt="" src="images\portfolio-04.jpeg">
                                        </a>
                                    </div>
                                    <!-- End Project Thumb -->
                                    <!-- Start Project Details -->
                            ...
                            <div class="portfolio-item item">
                                <div class="portfolio-border">
                                    <!-- Start Project Thumb -->
                                    <div class="portfolio-thumb">
                                        <a class="lightbox" title="This is an image title" href="images\portfolio-big-02.jpeg">
                                            <div class="thumb-overlay"><i class="icon-resize-full"></i></div>
                                            <img alt="" src="images\portfolio-05.jpeg">
                                        </a>
                                    </div>
                                    <!-- End Project Thumb -->
                                    <!-- Start Project Details -->
                    ...
                    <div class="row">
                    	...
                    	<div class="col-md-3" data-animation="fadeIn" data-animation-delay="03">
                            <div class="team-member modern">
                                ...
                                <div class="member-photo">
                                    <img alt="" src="images\member-01.jpeg">
                        ...
                        <div class="col-md-3" data-animation="fadeIn" data-animation-delay="04">
                            <div class="team-member modern">
                                <!-- Memebr Photo, Name & Position -->
                                <div class="member-photo">
                                    <img alt="" src="images\member-02.jpeg">
                        ...
                        <div class="col-md-3" data-animation="fadeIn" data-animation-delay="05">
                            <div class="team-member modern">
                                <!-- Memebr Photo, Name & Position -->
                                <div class="member-photo">
                                    <img alt="" src="images\member-03.jpeg">
                        ...
                        <div class="col-md-3" data-animation="fadeIn" data-animation-delay="06">
                            <div class="team-member modern">
                                <!-- Memebr Photo, Name & Position -->
                                <div class="member-photo">
                                    <img alt="" src="images\member-04.jpeg">
		...
		<footer>
			<div class="container">
				...
				<div class="copyright-section">
					<div class="row">
						<div class="col-md-6">
							<p>© 2013 Vella -  All Rights Reserved</p>
						</div>
						<div class="col-md-6">
							<ul class="footer-nav">
...
<noscript><a href="http://www.histats.com" target="_blank"><img src="http://sstatic1.histats.com/0.gif?2633271&101" alt="" border="0"></a></noscript>
<!-- Histats.com  END  -->
