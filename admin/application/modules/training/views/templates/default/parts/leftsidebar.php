<div class = "navbar-default sidebar" role = "navigation">
    <div class = "sidebar-nav navbar-collapse">
        <ul class = "nav" id = "side-menu">
            ...
            <li>
                <a href = "<?php echo site_url('Gallery'); ?>"><i class = "fa fa-dashboard fa-fw"></i> Gallery </a>
            </li>
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="<?php echo site_url('Instructor'); ?>">Instructor</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="<?php echo site_url('Batch'); ?>">Batch</a>
                    </li>
                    <li>
