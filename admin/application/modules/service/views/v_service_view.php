<div class="row">
    <div class="col-lg-12">
        <div class="col-lg-12">
            <a href="javascript:void(0);" onclick="showAjaxModal('<?php echo site_url();?>service/modal/popup/v_modal_service_add/');" class="btn btn-success">Add New Service <i class="fa fa-plus"></i></a>
        </div>
                                            ...
                                            <td class="center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                                        <li>
                                                            <a href="javascript:void(0);" onclick="showAjaxModal('<?php echo site_url();?>service/modal/popup/v_modal_service_edit/<?php echo $row['id'];?>');">
                                                        ...
                                                        <li class="divider"></li>
                                                        <li>
                                                            <a href="javascript:void(0);" onclick="confirm_modal('<?php echo base_url();?>service/bannerAction/delete/<?php echo $row['id'];?>/services');">
