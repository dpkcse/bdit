<div class="row">
    <div class="col-lg-12">
        <div class="col-lg-12">
            <a href="javascript:void(0);" onclick="showAjaxModal('<?php echo site_url();?>home/modal/popup/v_modal_gallery_add/');" class="btn btn-success">Add Photo/Video <i class="fa fa-plus"></i></a>
        </div>
                                ...
                                if(count($gallery) > 0){
                                    foreach($gallery as $row):?>
                                        <tr class="odd">
                                            ...
                                            <td class="center">
                                                <div class="btn-group">
                                                    <a href="javascript:void(0);" class="btn btn-sm btn-info" onclick="confirm_modal('<?php echo base_url();?>home/bannerAction/delete/<?php echo $row['id'];?>/gallery');">
