<div class="row">
    <div class="col-lg-12">
        <div class="col-lg-12">
            <a href="javascript:void(0);" onclick="showAjaxModal('<?php echo site_url();?>home/modal/popup/v_modal_slide_add/');" class="btn btn-success">Add New Slide <i class="fa fa-plus"></i></a>
        </div>
